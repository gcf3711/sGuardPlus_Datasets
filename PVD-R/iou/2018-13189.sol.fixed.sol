...
contract ICO is Pausable {
    uint256 public constant ICO_START_DATE = 1511773200;
    uint256 public constant ICO_END_DATE = 1525018620;
    address public constant admin = 0xFeC0714C2eE71a486B679d4A3539FA875715e7d8;
    address public constant teamWallet =
        0xf16d5733A31D54e828460AFbf7D60aA803a61C51;
    UNLB public unlb;
    bool public isFinished = false;
    event ForeignBuy(address investor, uint256 unlbValue, string txHash);
    ...
    function pricePerWei() public constant returns (uint256) {
    ...
    function() public payable {
        ...
        uint256 _tokenVal = (msg.value * pricePerWei()) / 1 ether;
    ...
    function finish(
        ...
        isFinished = true;
        uint256 _total = (unlb.totalSupply() * 100) / (100 - 12 - 15 - 5 - 3);

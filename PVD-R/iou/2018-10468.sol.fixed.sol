        ...
        if (msg.value >= 10 finney) {
            ...
            if (bonusHash[0] == 0) {
                uint8 bonusMultiplier = ((bonusHash[1] & 0x01 != 0) ? 1 : 0) +
                    ((bonusHash[1] & 0x02 != 0) ? 1 : 0) +
                    ((bonusHash[1] & 0x04 != 0) ? 1 : 0) +
                    ((bonusHash[1] & 0x08 != 0) ? 1 : 0) +
                    ((bonusHash[1] & 0x10 != 0) ? 1 : 0) +
                    ((bonusHash[1] & 0x20 != 0) ? 1 : 0) +
                    ((bonusHash[1] & 0x40 != 0) ? 1 : 0) +
                    ((bonusHash[1] & 0x80 != 0) ? 1 : 0);
                uint256 bonusTokensIssued = mul_uint256(
                    (mul_uint256(msg.value, 100)),
                    bonusMultiplier
                );
                tokensIssued = add_uint256(tokensIssued, bonusTokensIssued);
                totalBonusTokensIssued = add_uint256(
                    totalBonusTokensIssued,
                    bonusTokensIssued
                );
            }

...
contract PoCGame is sGuardPlus {
    ...
    function donate() public payable isOpenToPublic __lock_modifier0 {
    ...
    function donateToWhale(uint256 amount) internal __lock_modifier1 {
        bool __sent_result100 = whale.call.value(amount)(
    ...
    function loseWager(uint256 amount) internal __lock_modifier0 {
        bool __sent_result101 = whale.call.value(amount)(
            bytes4(keccak256("donate()"))
        );
